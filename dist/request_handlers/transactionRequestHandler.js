...
exports.transactionRequestHandler.post('/topup', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const topup = yield TransactionController_1.TransactionController.getInstance().topupAccount(amount);
        res.json(topup);
    }
    catch (error) {
        console.log(error);
...
exports.transactionRequestHandler.post('/:transactionId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const state = yield TransactionController_1.TransactionController.getInstance().getTransactionState(transactionId);
        console.log(state);
        res.json(state);
    }
    catch (error) {
